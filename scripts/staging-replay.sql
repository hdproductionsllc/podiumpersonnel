-- STAGING REPLAY BUNDLE — regenerated 2026-07-11 from supabase/migrations/ (001-065)
...
-- If you already ran an earlier 001-064 bundle on staging, just run 065 on its own.
