...
export function Footer() {
  return (
    <footer className="bg-ink-800 text-cream-100 relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-cream-300 font-body text-sm leading-relaxed max-w-xs mb-8">
              The modern way to manage your musicians. Built for quartets,
              ensembles, and orchestras who&apos;d rather play than administrate.
            </p>
            {/* Mini CTA */}
            <Link
      ...
      <div className="border-t border-ink-700/50">
        <div className="container-marketing py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-cream-500">
            Made with{" "}
            <span className="text-brass-400" aria-label="love">
              ♪
            </span>{" "}
