  ...
  return (
    <ProfileForm
      ...
      musician={{
        ...
        street_address: primaryMusician.street_address,
        city: primaryMusician.city,
        state: primaryMusician.state,
        zip_code: primaryMusician.zip_code,
        home_region: primaryMusician.home_region,
